...
export function ThreadIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-3.6-.8L3 21l1.9-5.3A8.5 8.5 0 1 1 21 11.5Z" />
      <path d="M8.5 12.5l2.2 2.2 4.3-4.3" />
    </svg>
  );
}

export function MyTurnIcon({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function StripIcon({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
