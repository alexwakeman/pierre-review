...
// repos. Clicking an entry navigates the MAIN timeline (FeedSection → openFeedEventOnTimeline):
// it opens the event's marker popover so the content reads inline + highlights it, and — for
// a CROSS-PERSON entry — enters the PR-isolation Focus overlay first (a lifecycle entry, which
// has no marker, just centres + glows). The new-item count lives on the header "Feed" pill;
// FeedSection marks the feed seen on mount, clearing that badge.
