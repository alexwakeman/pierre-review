...
// into clickable buttons (open the PR as a new tab). Intentionally tiny — the digests
// are a flat "- " bullet list, so we don't pull in a full markdown engine.
  ...
  return (
    <ul className="space-y-1">
      {bullets.map((line, i) => (
        <li
          key={i}
          className="flex gap-1.5 text-xs leading-relaxed text-gray-700 dark:text-gray-200"
        >
