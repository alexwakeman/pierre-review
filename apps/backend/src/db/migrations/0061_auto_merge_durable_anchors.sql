...
-- The Postgres twin is migrations-pg/0048_auto_merge_durable_anchors.sql.
--
...
ALTER TABLE `auto_merge_requests` ADD `expected_base_ref` text;--> statement-breakpoint
...
ALTER TABLE `auto_merge_requests` ADD `update_issued_against_oid` text;
